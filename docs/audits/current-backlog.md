...
| OPS-001 | Medium | in_progress | Added public readiness endpoint for required application workers; production deployment validation remains open. | Validate production configuration and add deployment readiness checks. | Readiness controller test passes |
